module github.com/BeardLeon/tiktok
...
replace (
	github.com/BeardLeon/tiktok/middleware/jwt => D:\ourtiktok\middleware\jwt
	github.com/BeardLeon/tiktok/pkg => D:\ourtiktok\pkg
)
